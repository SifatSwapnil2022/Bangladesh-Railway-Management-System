...
INSERT INTO `ddl` VALUES ('CREATE OR REPLACE TRIGGER trg_update_train_seat_availability',NULL,NULL),
	...
	('    TRAIN_TYPE_NAME VARCHAR(100) NOT NULL',NULL,NULL),
	(');',NULL,NULL),
	(NULL,NULL,NULL),
	...
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	('CREATE SEQUENCE Train_ID',NULL,NULL),
	('  START WITH 1005   -- Start from 8 digits',NULL,NULL),
	('  INCREMENT BY 1        -- Increment by 1 each time',NULL,NULL),
	(' ;  ',NULL,NULL),
	(NULL,NULL,NULL),
	(' CREATE TABLE Gender (',NULL,NULL),
	('    Gender_ID INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY',NULL,NULL),
	('    Gender_Name VARCHAR(50) NOT NULL',NULL,NULL),
	(');',NULL,NULL),
	('INSERT INTO Gender (Gender_Name)',NULL,NULL),
	('VALUES',NULL,NULL),
	('(''Male'');',NULL,NULL),
	(NULL,NULL,NULL),
	('INSERT INTO Gender (Gender_Name)',NULL,NULL),
	...
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	('CREATE SEQUENCE PASSENGER_ID',NULL,NULL),
	('  START WITH 10000   -- Start from 8 digits',NULL,NULL),
	('  INCREMENT BY 1        -- Increment by 1 each time',NULL,NULL),
	(' ;   ',NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	('CREATE SEQUENCE CARGO_ID',NULL,NULL),
	('  START WITH 50000   -- Start from 8 digits',NULL,NULL),
	('  INCREMENT BY 1        -- Increment by 1 each time',NULL,NULL),
	(' ;   ',NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	(' CREATE SEQUENCE DEPARTMENT_ID',NULL,NULL),
	('  START WITH 60000   -- Start from 8 digits',NULL,NULL),
	('  INCREMENT BY 1        -- Increment by 1 each time',NULL,NULL),
	(' ;   ',NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	(' CREATE TABLE railway_departments (',NULL,NULL),
	('    department_id NUMBER GENERATED BY DEFAULT AS IDENTITY',NULL,NULL),
	('    department_name VARCHAR2(100) NOT NULL',NULL,NULL),
	('    PRIMARY KEY (department_id)',NULL,NULL),
	(');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Operations Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Civil Engineering Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Mechanical Engineering Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Electrical Engineering Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Signal and Telecommunications Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Traffic Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Accounts and Finance Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Personnel and Human Resources Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Safety Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Stores Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Medical Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Security Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Planning and Research Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Legal Department'');',NULL,NULL),
	('INSERT INTO railway_departments (department_name) VALUES (''Public Relations Department'');',NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	('CREATE TABLE employee_roles (',NULL,NULL),
	('    role_id NUMBER GENERATED BY DEFAULT AS IDENTITY',NULL,NULL),
	('    role_name VARCHAR2(100) NOT NULL',NULL,NULL),
	('    PRIMARY KEY (role_id)',NULL,NULL),
	(');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Train Operator'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Station Manager'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Track Inspector'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Signal Technician'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Ticket Collector'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Administrative Officer'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Mechanical Engineer'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Safety Inspector'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Accounts Manager'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Security Officer'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Commercial Officer'');',NULL,NULL),
	('INSERT INTO employee_roles (role_name) VALUES (''Public Relations Officer'');',NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	('CREATE SEQUENCE EMPLOYEE_ID',NULL,NULL),
	('  START WITH 70000   -- Start from 8 digits',NULL,NULL),
	('  INCREMENT BY 1        -- Increment by 1 each time',NULL,NULL),
	(' ;   ',NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	...
	('  INCREMENT BY 1        -- Increment by 1 each time',NULL,NULL),
	(' ;   ',NULL,NULL),
	(' CREATE SEQUENCE STATION_ID',NULL,NULL),
	('  START WITH 80000   -- Start from 8 digits',NULL,NULL),
	('  INCREMENT BY 1        -- Increment by 1 each time',NULL,NULL),
	(' ;   ',NULL,NULL),
	(NULL,NULL,NULL),
	(' CREATE TABLE railway_stations (',NULL,NULL),
	('    station_id NUMBER GENERATED BY DEFAULT AS IDENTITY',NULL,NULL),
	('    station_name VARCHAR2(100) NOT NULL',NULL,NULL),
	('    PRIMARY KEY (station_id)',NULL,NULL),
	(');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Dhaka Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Chittagong Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Sylhet Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Rajshahi Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Khulna Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Jessore Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Mymensingh Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Comilla Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Narayanganj Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Rangpur Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Bogra Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Tangail Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Panchagarh Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Dinajpur Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Brahmanbaria Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Noakhali Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Lalmonirhat Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Sirajganj Railway Station'');',NULL,NULL),
	('INSERT INTO railway_stations (station_name) VALUES (''Ishwardi Railway Junction'');',NULL,NULL),
	(NULL,NULL,NULL),
	(NULL,NULL,NULL),
	('CREATE TABLE user_signup (',NULL,NULL),
	('    user_id NUMBER primary key',NULL,NULL),
	('    full_name VARCHAR2(100) NOT NULL',NULL,NULL),
	('    email VARCHAR2(100) NOT NULL UNIQUE',NULL,NULL),
	('    password VARCHAR2(100) NOT NULL',NULL,NULL),
	('    phone_number VARCHAR2(15)',NULL,NULL),
	('    date_of_birth DATE',NULL,NULL),
	('    gender VARCHAR2(10)',NULL,NULL),
	('    address VARCHAR2(200)',NULL,NULL),
	('    signup_date DATE DEFAULT SYSDATE',NULL,NULL),
	('    ',NULL,NULL),
	(');',NULL,NULL),
	('CREATE SEQUENCE USER_ID',NULL,NULL),
	('  START WITH 1  -- Start from 8 digits',NULL,NULL),
	('  INCREMENT BY 1        -- Increment by 1 each time',NULL,NULL),
	(' ;  ',NULL,NULL),
	(NULL,NULL,NULL),
	('create or replace TRIGGER trg_ticket_booking',NULL,NULL),
	('BEFORE INSERT ON ticket',NULL,NULL),
	('FOR EACH ROW',NULL,NULL),
	('BEGIN',NULL,NULL),
	('    IF :NEW.booking_bookingid IS NULL THEN',NULL,NULL),
	('        RAISE_APPLICATION_ERROR(-20001',' ''Booking ID must be provided for ticket booking.'');',NULL),
	('    END IF;',NULL,NULL),
	('END;',NULL,NULL),
	('/',NULL,NULL),
	(NULL,NULL,NULL),
	('create or replace TRIGGER trg_booking_with_ticket_connections',NULL,NULL),
	('BEFORE INSERT ON booking',NULL,NULL),
	('FOR EACH ROW',NULL,NULL),
	('DECLARE',NULL,NULL),
	('    v_ticket_count NUMBER;',NULL,NULL),
	('BEGIN',NULL,NULL),
	('    SELECT COUNT(*)',NULL,NULL),
	('    INTO v_ticket_count',NULL,NULL),
	('    FROM ticket',NULL,NULL),
	('    WHERE booking_bookingid = :NEW.bookingid;',NULL,NULL),
	(NULL,NULL,NULL),
	('    IF v_ticket_count = 0 THEN',NULL,NULL),
	('        RAISE_APPLICATION_ERROR(-20004',' ''Booking must have at least one associated ticket.'');',NULL),
	('    END IF;',NULL,NULL),
	('END;',NULL,NULL),
	('/',NULL,NULL),
	(NULL,NULL,NULL),
	('CREATE TABLE TrainSeats (',NULL,NULL),
	('    id INT PRIMARY KEY',NULL,NULL),
	('    seat_name VARCHAR(50) NOT NULL',NULL,NULL),
	('  ',NULL,NULL),
	(');',NULL,NULL),
	(NULL,NULL,NULL),
	('INSERT INTO TrainSeats (id',' seat_name) VALUES',NULL),
	('(1',' ''Shovon Chair'')',NULL),
	...
	(NULL,NULL,NULL),
	('create or replace TRIGGER trg_user_ticket_purchase',NULL,NULL),
	('AFTER INSERT ON ticket',NULL,NULL),
	('FOR EACH ROW',NULL,NULL);
INSERT INTO `ddl` VALUES ('DECLARE',NULL,NULL),
	('    v_user_name VARCHAR2(100);',NULL,NULL),
	('BEGIN',NULL,NULL),
	('    SELECT full_name INTO v_user_name',NULL,NULL),
	('    FROM user_signup',NULL,NULL),
	('    WHERE user_id = :NEW.booking_bookingid;  -- Assuming booking_bookingid relates to user_id',NULL,NULL),
	(NULL,NULL,NULL),
	('    DBMS_OUTPUT.PUT_LINE(''User '' || v_user_name || '' has purchased a ticket with ID '' || :NEW.ticketid);',NULL,NULL),
	('END;',NULL,NULL),
	('/',NULL,NULL);
